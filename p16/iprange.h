...
#define NETADDR_INC 100
  ...
  for (n = 0; fscanf(fp, "%20s", ipstr) != EOF; n++) {
    if (n >= nmax) {
      nmax += NETADDR_INC;
      netaddrs =
          (network_addr_t * )realloc(netaddrs, nmax * sizeof(network_addr_t));
    }
...
//   if ( (argc == 2 || argc == 3) &&
//        ((Jflg = (strcmp(argv[1], "-J") == 0)) || (strcmp(argv[1], "-j") ==
//        0))
//      ) {
...
//           "   -j [file]\n"
//           "       Join the network addresses given as A.B.C.D[/M] in
//           \"file\"\n" "       and print out ranges to stdout. Unless \"file\"
//           is given,\n" "       file=stdin will be used.\n"
//           "\n"
//           "   -J [file]\n"
//           "       Same as \"-j\", except that joined results are printed
//           as\n" "       the minimum required number of CIDR network address
//           blocks.\n"
//           "\n"
//           "   -s <start-addr> <end-addr>\n"
//           "       Split the range from \"start-addr\" to \"end-addr\" into\n"
//           "       the minimum number of CIDR network address blocks
//           required\n" "       to cover it. \"start-addr\" and \"end-addr\"
//           may be of the\n" "       form A.B.C.D[/M].\n"
//           "\n"
//           "   \"A.B.C.D\" is an IPv4 network address ( 0 <= A/B/C/D <= 255
//           ).\n" "   \"M\" is the CIDR representation of a netmask value ( 1
//           <= M <= 32 ).\n"
//           "\n"
//           , PROG);
//   return( 1 );
